  ...
  return (
    <div className="bg-white">
      <h3 className="m-0">
        <button
          id={buttonId}
          className="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        ...
        >
          ...
          <span
            className={`ml-3 inline-flex h-6 w-6 items-center justify-center rounded-lg bg-primary text-white transition-transform ${isOpen ? "rotate-90" : ""}`}
            aria-hidden="true"
          >
            ▸
          </span>
